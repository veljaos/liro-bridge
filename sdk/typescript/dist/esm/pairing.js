...
import { encodeJSON, parseJSON } from './transport.js';
/**
...
export async function pair(args) {
    ...
    const requestBody = parseJSON(requested, 'POST /v2/pair/request');
    ...
    for (;;) {
        ...
        return toPairing(parseJSON(confirmed, 'POST /v2/pair/confirm'), applicationName, origin);
    }
}
/**
