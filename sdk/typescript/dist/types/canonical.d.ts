...
export declare const HEADER_APP_ID = "X-Liro-App-Id";
export declare const HEADER_TIMESTAMP = "X-Liro-Timestamp";
export declare const HEADER_NONCE = "X-Liro-Nonce";
export declare const HEADER_SIGNATURE = "X-Liro-Signature";
/**
...
export declare const MAX_NONCE_LENGTH = 128;
/** SHA-256 over `body`, lowercase hex. */
export declare function sha256Hex(body: Uint8Array): string;
/**
 ...
 * canonical strings.
 */
export declare function canonicalString(method: string, path: string, timestamp: string, nonce: string, body: Uint8Array): string;
/**
 ...
 */
export declare function signCanonical(deviceSecret: Uint8Array, canonical: string): string;
/**
...
export declare function unixSeconds(now?: Date): string;
