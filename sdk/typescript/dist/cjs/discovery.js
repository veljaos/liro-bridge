...
exports.defaultBridgeFilePath = defaultBridgeFilePath;
exports.readBridgeFile = readBridgeFile;
...
function defaultBridgeFilePath() {
    switch (process.platform) {
        case 'win32': {
            ...
            if (local) {
                return (0, node_path_1.join)(local, 'Liro', 'bridge.json');
            }
            return (0, node_path_1.join)((0, node_os_1.homedir)(), 'AppData', 'Local', 'Liro', 'bridge.json');
        }
        case 'darwin':
            return (0, node_path_1.join)((0, node_os_1.homedir)(), 'Library', 'Application Support', 'Liro', 'bridge.json');
        default: {
            const runtime = process.env['XDG_RUNTIME_DIR'];
            if (runtime) {
                return (0, node_path_1.join)(runtime, 'liro', 'bridge.json');
            }
            return (0, node_path_1.join)((0, node_os_1.homedir)(), '.local', 'state', 'liro', 'bridge.json');
        }
    }
}
/**
 ...
 */
async function readBridgeFile(path) {
    let text;
    try {
        text = await (0, promises_1.readFile)(path, 'utf8');
    }
    catch (err) {
        throw new errors_js_1.LiroError('AGENT_NOT_RUNNING', {
